            ...
            <div className="max-w-xl  mx-auto lg:mr-auto lg:ml-0">
                ...
                {cartItems.map((item) => {
                  ...
                  return (
                    <div key={productId} className="flex items-start space-x-4">
                      ...
                      <div className="text-sm font-medium text-gray-900 price-font">
              ...
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-gray-900 price-font">{formatPrice(subtotal)}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Shipping</span>
                  { selectedShipping?.price ? <span className="text-gray-900 price-font">{selectedShipping.price}</span> : <span className="text-gray-900 w-28 h-3 bg-gray-200 rounded-md"></span>}
                </div>
              </div>
              ...
              <div className="flex justify-between items-baseline">
                ...
                <div className="text-right">
                  ...
                  <span className="text-2xl price-font text-gray-900">
