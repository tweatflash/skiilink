...
import { ShoppingCart, Search, Sun, Moon, Menu, X, User, CircleUser, ChevronDownIcon, ShoppingBag, User2 } from 'lucide-react';
      ...
      <div className="max-screen mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href={"/"} className='flex flex-row'>
            ...
            <div>
              <span className='text-gray-700 text-[22.5px] font-[famil] !tracking-wide hidden sm:flex uppercase leading-[1]'>SKIILINK</span>
              <span className='text-gray-700 hidden med-livvic tracking-wide sm:flex text-xs uppercase  leading-[1]'>VENTURES LIMITED</span>
            </div>
          ...
          <div className="flex items-center space-x-1">
            ...
            <button
              ...
              className="p-2.5 rounded-3xl  active:scale-[0.97] bg-gray-200 transition-colors duration-200"
              aria-label="User"
            >
               <User2 size={20} className="text-gray-600 dark:text-gray-400" />
             
            </button>

            {/* Search Button - Mobile */}
            <button className="md:hidden p-2.5 rounded-3xl  active:scale-[0.97] bg-gray-200  transition-colors duration-200 cursor-pointer" onClick={()=>setSearch(true)}>
            ...
            <button
              ...
              className="relative p-2.5 text-gray-600 bg-gray-200 rounded-3xl transition-all duration-200 transform  active:scale-[0.97]"
            >
              <ShoppingBag size={20} />
              {cartItemCount > 0 && (
