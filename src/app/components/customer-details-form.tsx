...
export function CustomerDetailsForm() {
  const { setCustomerDetails, setStep, customerDetails, selectedShipping } =
    useCheckoutStore();
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <select
              id="country"
              {...register("states")}
              className="w-full h-10 px-3 bg-gray-100 rounded-xl text-gray-900"
            >
              {[
                "Abia",
                "Adamawa",
      ...
      <div className="pt-4">
        <Button
          ...
          className="w-full text-white text-base font-medium rounded-xl"
        >
