...
const ProductOverview: React.FC<ProductOverviewProps> = ({ product, onBack, onAddToCart }) => {
                    ...
                    <dl className="space-y-3">
                      ...
                      {product.model && (
                        <div className="flex justify-between">
                          ...
                          <dd className="font-medium text-gray-900">{product.model}</dd>
                        </div>
                      )}
                      {product.weight && (
                        <div className="flex justify-between">
                      ...
                      {product.warranty && (
                        <div className="flex justify-between">
                          ...
                          <dd className="font-medium text-gray-900">{product.warranty}</dd>
                        </div>
                      )}
                    </dl>
                  </div>
                  ...
                  {[
                    {
                      ...
                      rating: 5,
                      date: "2 weeks ago",
                      comment: "Excellent product! Works exactly as described. Installation was straightforward and the quality is outstanding."
                    },
                    {
                      name: "Fatima A.",
                      rating: 4,
                      date: "1 month ago",
                      comment: "Very good value for money. The performance has been consistent and reliable. Would recommend to others."
                    },
                    {
                      name: "Chidi N.",
                      rating: 5,
                      date: "2 months ago",
                      comment: "Top quality product with excellent customer service. Delivery was fast and packaging was secure."
                    }
                  ].map((review, index) => (
