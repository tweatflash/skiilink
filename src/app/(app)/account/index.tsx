    ...
    <div className="w-full min-h-[70vh] flex items-center justify-center px-4">
      <div className="w-full max-w-[420px] flex flex-col items-center text-center gap-5">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-base med-livvic text-gray-500 leading-body tracking-body">
            Log in to manage your orders, saved items, and account details.
          </p>
        </div>
        <Link
          href="/sign-in"
          className="w-full mt-2 px-6 py-3 med-livvic text-lg flex justify-center items-center rounded-3xl text-white bg-gradient-to-b from-orange-400 to-orange-600 shadow-[0_1px_3px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.2)] transition-all duration-200 hover:from-orange-400 hover:to-orange-500 hover:shadow-[0_3px_12px_rgba(249,115,22,0.4),inset_0_1px_0_rgba(255,255,255,0.25)] active:scale-[0.97]"
        >
          Sign in
        </Link>
        <p className="text-base med-livvic text-gray-500">
