...
document.querySelector('.file').addEventListener('change', function(event) {
  ...
  if (file) {
    ...
    reader.onload = () => {
      ...
      formData.append('title', "Nike Air Max 270");
      formData.append('description', "A stylish and comfortable sneaker with responsive cushioning.");
      formData.append('category', "Footwear");
      formData.append('price', 120.99);
